...
const (
	SortOrder_ASC  SortOrder_Direction = 0 // 升序
	SortOrder_DESC SortOrder_Direction = 1 // 降序
)
...
type ListRequest struct {
	...
	Sort  []*SortOrder `protobuf:"bytes,3,rep,name=sort,proto3" json:"sort,omitempty"`
}
...
func (x *ListRequest) GetPn() uint32 {
	if x != nil {
		return x.Pn
	}
	return 0
...
func (x *ListRequest) GetPSize() uint32 {
	if x != nil {
		return x.PSize
	}
	return 0
...
func (x *ListRequest) GetSort() []*SortOrder {
	if x != nil {
		return x.Sort
	}
	return nil
...
type SortOrder struct {
	...
	Field string              `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`                           // 排序字段的名称
	Order SortOrder_Direction `protobuf:"varint,2,opt,name=order,proto3,enum=SortOrder_Direction" json:"order,omitempty"` // 排序顺序
}
...
var file_user_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x57, 0x6f,
	...
	0xb8, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0c, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
...
var file_user_proto_depIdxs = []int32{
	4,  // 0: ListRequest.sort:type_name -> SortOrder
	0,  // 1: SortOrder.order:type_name -> SortOrder.Direction
	9,  // 2: UserListResponse.data:type_name -> UserInfoResponse
	3,  // 3: User.GetUserList:input_type -> ListRequest
	5,  // 4: User.GetUserByMobile:input_type -> MobileRequest
	6,  // 5: User.GetUserById:input_type -> IdRequest
	7,  // 6: User.CreateUser:input_type -> CreateUserInfo
	8,  // 7: User.UpdateUser:input_type -> UpdateUserInfo
	1,  // 8: User.CheckPassWord:input_type -> PasswordCheckInfo
	10, // 9: User.GetUserList:output_type -> UserListResponse
	9,  // 10: User.GetUserByMobile:output_type -> UserInfoResponse
	9,  // 11: User.GetUserById:output_type -> UserInfoResponse
	9,  // 12: User.CreateUser:output_type -> UserInfoResponse
	11, // 13: User.UpdateUser:output_type -> google.protobuf.Empty
	2,  // 14: User.CheckPassWord:output_type -> CheckResponse
