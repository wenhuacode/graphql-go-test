...
func (c *PetClient) UpdateOneID(id xid.ID) *PetUpdateOne {
...
func (c *PetClient) DeleteOneID(id xid.ID) *PetDeleteOne {
...
func (c *PetClient) Get(ctx context.Context, id xid.ID) (*Pet, error) {
	return c.Query().Where(pet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PetClient) GetX(ctx context.Context, id xid.ID) *Pet {
...
// QueryPrev queries the prev edge of a User.
func (c *UserClient) QueryPrev(u *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
...
// QueryNext queries the next edge of a User.
func (c *UserClient) QueryNext(u *User) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
