...
func (pq *PetQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (pq *PetQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (pq *PetQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (pq *PetQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (pq *PetQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (pq *PetQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
